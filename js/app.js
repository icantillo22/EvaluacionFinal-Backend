  ...
  var Propiedades = {
    ...
    ajaxData: function(datos){
      ...
      $.ajax({
        ...
        self.renderPropiedades(newData)
      })
    },
    ...
    renderPropiedades: function(bienes){
      var self = this
      var bien = bienes
      self.contProp.html('')
      ...
      bien.map((bien)=>{
        ...
        var newProp = bienTemplate.replace(':direccion:', bien.Direccion)
